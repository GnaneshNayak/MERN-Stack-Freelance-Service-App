import './Gig.scss';
import Sildes from '../../components/Slides/Sildes';
      ...
      <div className="container">
        <div className="left">
          ...
          <Slider slidesToShow={1} arrowsScroll={1} className="slider">
            <img
              src="https://c.ndtvimg.com/2023-06/tnsc6ik8_personalities-playing-holi_625x300_18_June_23.jpg?im=Resize=(1230,900)"
              alt=""
            />
            <img
